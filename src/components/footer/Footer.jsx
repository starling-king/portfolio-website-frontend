        ...
        <footer className="bg-slate-50 border-t border-gray-200">
            <div className="mx-auto w-full max-w-7xl p-4 py-8 lg:py-10">
                <div className="flex flex-col md:flex-row md:justify-between">
                    ...
                    {/* Changed grid-cols-2 to grid-cols-1 for tiny screens, scaling up cleanly */}
                    <div className="grid grid-cols-1 gap-8 min-[400px]:grid-cols-2 sm:gap-6 sm:grid-cols-3">
                        <div>
                            <h2 className="mb-6 text-sm font-semibold tracking-wider uppercase text-slate-900">Resources</h2>
                            <ul className="space-y-4 font-medium text-slate-600">
                                <li>
                                    <Link to="/" className="transition-colors hover:text-indigo-600">Home</Link>
                                </li>
                                <li>
                                    <Link to="/project" className="transition-colors hover:text-indigo-600">Projects</Link>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold tracking-wider uppercase text-slate-900">Connect</h2>
                            <ul className="space-y-4 font-medium text-slate-600">
                                <li>
                                    <a href="https://github.com/starling-king" className="transition-colors hover:text-indigo-600" target="_blank" rel="noreferrer">GitHub</a>
                                </li>
                                <li>
                                    <a href="https://www.linkedin.com/in/ayushmishra6518" className="transition-colors hover:text-indigo-600" target="_blank" rel="noreferrer">LinkedIn</a>
                                </li>
                            </ul>
                        </div>
                        <div>
                            <h2 className="mb-6 text-sm font-semibold tracking-wider uppercase text-slate-900">Legal</h2>
                            <ul className="space-y-4 font-medium text-slate-600">
                                <li>
                                    <Link to="#" className="transition-colors hover:text-indigo-600">Privacy Policy</Link>
                                </li>
                                <li>
                                    <Link to="#" className="transition-colors hover:text-indigo-600">Terms &amp; Conditions</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
