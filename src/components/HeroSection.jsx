...
return (
    // PSYCH-UI: Tightened mobile padding (pt-12 pb-16) so the ID card peeks above the fold
    <section className="relative flex items-center min-h-[80vh] px-4 pt-12 pb-16 lg:py-24 overflow-hidden transition-colors duration-300">
      ...
      {/* Main Content Grid - Tightened gap on mobile from gap-12 to gap-8 */}
      <div className="relative z-10 w-full max-w-7xl mx-auto grid lg:grid-cols-12 gap-8 lg:gap-8 items-center">
        
        {/* LEFT COLUMN (7 Cols): Narrative & Actions */}
        <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left order-1">
          
          <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-5 lg:mb-6 rounded-full bg-emerald-50 dark:bg-emerald-500/10 border border-emerald-200 dark:border-emerald-500/20 shadow-sm gpu-layer cursor-default">
            <span className="relative flex h-2 w-2">
              <span className="animate-ping absolute inline-flex h-full w-full rounded-full bg-emerald-400 opacity-75"></span>
              <span className="relative inline-flex rounded-full h-2 w-2 bg-emerald-500"></span>
            </span>
          ...
          <h2 className="mt-5 lg:mt-6 text-xl sm:text-2xl lg:text-3xl font-bold text-slate-700 dark:text-slate-300 tracking-wide lg:border-l-4 lg:border-emerald-500 lg:pl-4">
            {role || "Software Developer"}
          </h2>
        ...
        <div className="lg:col-span-5 relative w-full max-w-70 sm:max-w-80 mx-auto lg:ml-auto lg:mr-0 order-2 gpu-layer group mt-4 lg:mt-0">
          ...
          <div className="absolute -inset-6 bg-linear-to-tr from-emerald-500/30 to-teal-500/30 dark:from-emerald-500/30 dark:to-teal-500/30 blur-3xl rounded-[3rem] -z-10 transition-all duration-700 group-hover:scale-110 opacity-70" />
