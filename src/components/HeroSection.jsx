...
//             />
//           ) : (
//             <div className="flex items-center justify-center w-full h-full text-5xl sm:text-6xl font-black text-primary-600 dark:text-primary-400 bg-primary-50 dark:bg-primary-500/10">
//               {initial}
//             </div>
//           )}
//         </div>
...
//           size="lg"
//           variant="primary"
//           className="w-full sm:w-auto shadow-primary-500/50"
//         >
//           View Projects
//         </Button>
//       </div>
...
//           {/* Narrative Hook */}
//           <div className="inline-flex items-center gap-2 px-3 py-1.5 mb-6 rounded-full bg-primary-50 dark:bg-primary-500/10 border border-primary-200 dark:border-primary-500/20 shadow-sm gpu-layer cursor-default">
...
//           <h2 className="mt-6 text-xl sm:text-2xl lg:text-3xl font-bold text-slate-700 dark:text-slate-300 tracking-wide lg:border-l-4 lg:border-primary-500 lg:pl-4">
//             {role || "Software Developer"}
//           </h2>
