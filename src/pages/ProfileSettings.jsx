    ...
    <div className="w-full px-4 py-8 mx-auto max-w-5xl space-y-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-slate-600">
          Manage your administrative credentials and public portfolio presence.
        </p>
      </div>
      ...
      <div className="p-8 bg-white border border-slate-200 rounded-2xl shadow-sm">
        ...
        {portfolioStatus.success && (
          <div className="p-4 mb-4 text-sm text-green-700 bg-green-50 border border-green-200 rounded-lg">
            {portfolioStatus.success}
          </div>
        )}
        ...
        <form onSubmit={handlePortfolioSubmit} className="space-y-6">
            ...
            <div className="flex flex-col items-center gap-4 shrink-0">
              <div className="relative w-32 h-32 overflow-hidden bg-slate-100 border-2 border-dashed rounded-full border-slate-300">
                {portfolioForm.profilePhotoUrl ? (
                  ...
                  <svg
                    className="absolute w-12 h-12 text-slate-400 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
            ...
            <div className="grow space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none"
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handlePortfolioChange}
              rows="3"
              className="w-full px-4 py-2 text-slate-900 border border-slate-300 rounded-lg focus:ring-2 focus:ring-indigo-500 outline-none resize-y"
          ...
          <form onSubmit={handleAdminSubmit} className="space-y-4">
            ...
            <div className="flex justify-end pt-4">
              <button
                ...
                className="px-6 py-2.5 font-bold text-white bg-slate-900 rounded-lg hover:bg-slate-800 disabled:opacity-70 transition-colors"
              >
          ...
          <form onSubmit={handlePasswordSubmit} className="space-y-4">
            ...
            <div className="flex items-center justify-between pt-4">
              ...
              <button
                ...
                className="px-6 py-2.5 font-bold text-red-600 bg-red-50 border border-red-200 rounded-lg hover:bg-red-100 disabled:opacity-70 transition-colors"
              >
