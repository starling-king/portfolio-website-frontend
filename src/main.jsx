    ...
    children: [
      ...
      { 
        ...
        children: [
            ...
            // We group the "projects" routes into a strict parent/child tree
            {
                path: "projects",
                children: [
                    { index: true, element: <AdminProjectList /> }, // Loads on /admin/projects
                    { path: "new", element: <ProjectEditorForm /> }, // Loads on /admin/projects/new
                    { path: "edit/:id", element: <ProjectEditorForm /> } // Loads on /admin/projects/edit/:id
                ]
            },
